...
public sealed class GroqProvider : IModelProvider
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (string.IsNullOrEmpty(textContent))
            throw new AiEmptyResponseException(AiResponseError.EmptyAfterRetries, "Groq returned no text — server-side data loss; usually transient, re-run the operation.");
