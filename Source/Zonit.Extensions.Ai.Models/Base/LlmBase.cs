...
public abstract class LlmBase : ILlmBase, IModelBase
{
    ...
    // IModelBase implementation - map legacy types to new types
    ModalityType IModelBase.InputModalities => (ModalityType)(int)Input;
    ModalityType IModelBase.OutputModalities => (ModalityType)(int)Output;
    ToolType IModelBase.SupportedTools => (ToolType)(int)SupportedTools;
    FeatureType IModelBase.SupportedFeatures => (FeatureType)(int)SupportedFeatures;
    EndpointType IModelBase.SupportedEndpoints => (EndpointType)(int)SupportedEndpoints;
}