...
//    public async Task<Result<IFile>> GenerateImageAsync(string prompt, ILlmBase model, CancellationToken cancellationToken = default)
//    {
...
//        if (model is not IImageBase imageModel)
...
//    public Task<Result<IReadOnlyCollection<IFile>>> GenerateImagesAsync(string prompt, ILlmBase model, CancellationToken cancellationToken = default)
//    {
