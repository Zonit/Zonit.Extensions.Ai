...
public class AiPromptBindingGenerator : IIncrementalGenerator
{
    ...
    private static PromptBindingInfo? GetPromptBindingInfo(GeneratorSyntaxContext context)
    {
        ...
        // The binding is registered as typeof(prompt); skip prompts the generated code cannot
        // name (private/protected nested types) — they fall back to reflection-based rendering.
