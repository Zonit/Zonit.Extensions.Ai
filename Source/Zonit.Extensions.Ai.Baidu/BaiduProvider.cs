...
public sealed class BaiduProvider : IModelProvider
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (string.IsNullOrEmpty(textContent))
            throw new AiEmptyResponseException(AiResponseError.EmptyAfterRetries, "Baidu returned no text — server-side data loss; usually transient, re-run the operation.");
