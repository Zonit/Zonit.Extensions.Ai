...
/// source-generated <c>XJsonContext</c> or <c>JsonDocument</c>. No class-level
/// trim/AOT suppression is required.
/// </remarks>
internal sealed class XAgentSession : IAgentSession
{
    ...
    // (build-time AiSchemaRegistry schema + source-generated XJsonContext).
    ...
    private XResponsesRequest BuildRequest()
    {
        ...
        // Grok models that accept the `reasoning.effort` field:
        //  - grok-4.3: thinking depth (none/low/medium/high), default "low".
