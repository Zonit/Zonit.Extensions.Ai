...
public class ResultAgentTests
{
    ...
    public void ResultAgent_ExposesAggregatedTotals()
    {
        ...
        result.Total.Tokens.TotalTokens.Should().Be(1500);
        result.Total.Cost.Value.Should().BeGreaterThan(0);
        result.Request.Tokens.TotalTokens.Should().Be(1500);
    }
    ...
    private static ResultAgent<string> BuildSample(string value)
    {
        ...
        return new ResultAgent<string>
        {
            ...
            Request = new AiUsageSummary { Tokens = usage, Calls = 3 },
            Total = new AiUsageSummary { Tokens = usage, Calls = 3 },
        };
    }
